<section class="pt-0  position-relative overflow-hidden my-auto">
	...
	<div class="container position-relative">
		<div class="row g-5 align-items-center justify-content-center">
			<div class="col-lg-5">
				<!-- Title -->
				<h1 class="mt-4 mt-lg-0">Su registro ha sido confirmado exitosamente!</h1>
				<!-- info -->
			...
			<div class="col-lg-7 text-center">
				<!-- Image -->
				<img src="assets/images/element/05.svg" class="h-300px h-sm-400px h-md-500px h-xl-700px" alt="">
			</div>
		</div>
	</div>
</section>