...
<section class="bg-light py-5 position-relative overflow-hidden">
	...
	<div class="container position-relative">
		<div class="row g-4 align-items-center">
			<div class="col-md-6">
				<!-- Title -->
				<h1>Su registro ha sido aprobado!</h1>
				<p style="font-size:1.4rem;">
                    Estamos encantados de tenerte a bordo.<br>
                    ¡Prepárate para una experiencia única y con muchos beneficios! 🎉
                </p>
				<!-- Button -->
				<a href="index.php" class="btn btn-primary mb-0">Iniciar sesión</a>
			</div>
